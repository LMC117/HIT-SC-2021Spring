...
public class IntervalSetStaticTest {
    ...
    public void testDifferentDataLabel() {
        ...
        assertEquals("expected empty() IntervalSet to have no labels",
                Collections.emptySet(), IntervalSet.<Integer>empty().labels());
        assertEquals("expected empty() IntervalSet to have no labels",
                Collections.emptySet(), IntervalSet.<Float>empty().labels());
        assertEquals("expected empty() IntervalSet to have no labels",
                Collections.emptySet(), IntervalSet.<Double>empty().labels());
        assertEquals("expected empty() IntervalSet to have no labels",
                Collections.emptySet(), IntervalSet.<Boolean>empty().labels());
    }
}
