...
//        a.autoRosters();
    ...
    public void testManualRosters() {
        ...
        a.manualRosters("ZhangSan","2000.01.01","2000-02-01"); // 格式错误
        a.manualRosters("ZhangSan","2000-01-01","2000-02-30"); // 时间超范围
        a.manualRosters("ZhangSan","2000-01-01","2000-02-01"); // 正常排班
        a.manualRosters("LiSi","2000-02-02","2000-02-11"); // 正常排班
        a.manualRosters("WangWu","2000-02-12","2000-02-22"); // 正常排班
        a.manualRosters("WangWu","2000-02-23","2000-02-25"); // 检验重复排班
        a.manualRosters("ZhangSan","2000-02-23","2000-02-23"); // 输入的排班时间冲突
    ...
    public void testDeleteRoster(){
        ...
        a.setDate("2001-01-01","2001-01-30");

        a.addEmployee("a{boss,111-1111-1111}");

        a.manualRosters("a","2001-01-01","2001-01-10");
        a.manualRosters("a","2001-01-11","2001-01-20");
        a.manualRosters("a","2001-01-21","2001-01-30");
